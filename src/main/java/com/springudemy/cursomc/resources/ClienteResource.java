...
import com.springudemy.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<Cliente> list = cliServ.findPage(page, linesPerPage, orderBy, direction);
		Page<ClienteDTO> listDTO = list.map(obj -> new ClienteDTO(obj)); // Possível dessa forma, pois a classe Page já é um Java 8 compliance
		return ResponseEntity.ok().body(listDTO);
	}
